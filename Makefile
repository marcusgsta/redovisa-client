...
stylelint:
	...
	[ ! -f ../express-backend/.stylelintrc.json ] || $(STYLELINT) ../express-backend/**/*.scss
...
stylelint-fix:
	...
	[ ! -f ../express-backend/.stylelintrc.json ] || $(STYLELINT) ../express-backend/**/*.scss --fix
...
eslint:
	...
	[ ! -f ../express-backend/.eslintrc.json ] || $(ESLINT) ../express-backend/
...
eslint-fix:
	@$(call HELPTEXT,$@)
	[ ! -f ../express-backend/.eslintrc.json ] || $(ESLINT) --fix ../express-backend/
